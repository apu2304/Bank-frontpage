  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <h1 className='font-poppins font-semibold ss:text-[68px] w-full text-[52px] ss:leading-[100px] leading-[75px] text-white'>
        Payment Method.
        </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-o my-10 relative`}>
        ...
        <div className='absolute z-[1] bottom-40 w-[80%] rounded-full h-[80%] white__gradient'/>
